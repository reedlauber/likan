...
function Model(conn_string, table, options) {
  ...
  this.process = function(data, callback) { callback(data); };
  ...
  this._process = function(data, callback) {
    processor.public(data, _public_fields, function(data) {
